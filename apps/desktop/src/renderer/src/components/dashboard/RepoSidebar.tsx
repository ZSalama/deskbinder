                  ...
                  <div className="flex min-w-0 items-center gap-3">
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          type="button"
                          className="flex min-w-0 flex-1 basis-0 items-center gap-2 overflow-hidden text-left text-sm font-semibold text-slate-100"
                          onClick={() => onSelectRepo(group.root.id)}
                        >
                          <ChevronDown className="size-4 shrink-0 text-slate-500" />
                          <Folder className="size-5 shrink-0 text-slate-300" />
                          <span className="block min-w-0 max-w-[8.75rem] truncate">
                            {group.name}
                          </span>
                        </button>
                      </TooltipTrigger>
